...
| <a name="input_internet_security_enabled"></a> [internet\_security\_enabled](#input\_internet\_security\_enabled) | Whether internet security is enabled for the Point-to-Site VPN Gateway connections, it will include/remove 0.0.0.0/0 in the route table.<br>    Although it seems you can set this per connection, this is not the case. | `bool` | `null` | no |
